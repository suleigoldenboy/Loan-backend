        ...
        <div class="ac_chart">
          ...
          <div class="reports-breads">
            ...
            <span class="filter-txt-highligh">
              ...
              {{$get_fromDate}} - {{$get_toDate}}
                ...
                For the 
            <span class="filter-txt-highligh"> ({{$tranRec->name}}) Account (Code: {{$tranRec->code}}) </span>
          ...
          <div class="col-sm-1">
             ...
             <table class="table table-striped table-bordered">
              ...
              <?php $transActionID = 1; $sumTotal = 0; $sum = 0;  $sumDebit = 0; $sumCredit = 0; $checkBalanceCount = 0;  $mainBalance = 0; $sumMainTotal = 0; ?>
                 ...
                 @if($checkBalanceCount == 0)
                  ...
                  <td>
                    ...
                    <?php 
                      ...
                      $the_cur_balance = AccountsController::getCurrentAccountBalance($tranRec->id,$fromDate); 
                ...
                <?php $sum = AccountsController::getAddBalance(); $checkBalanceCount = 1; $transActionID += 1; ?>
                 @endif

                @foreach(AccountsController::getAccTransHistory($tranRec->id,$tranRec->code,$fromDate,$toDate) as $tran)
                      ...
                      $displayBalnce = AccountsController::getAddBalance();
                        ...
                        if($tran->transaction_type == "Credit"){
                         ...
                         $mainBalance = intval(-$tran->credit_amount) + $sumMainTotal;
                          ...
                          $theValue = str_replace( '-', '', $tran->credit_amount);

                          $mainBalance = intval($theValue) + $sumMainTotal;
                        }
