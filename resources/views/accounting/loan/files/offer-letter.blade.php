...
<body>
<div class="row" style="background-color:#FFF; padding:72px;">
    <div class="col-md-10">
         <div class="col-md-12">
      <img src="{{ asset('https://ukdiononline.com/assets/images/maxer.jpg')}}" class="img-responsive">
      </div>
    
    <div class="col-md-12" style="margin-top:70px; padding-top:5px;">
        <?php
        ...
        <div class="media-body">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <h4 class="text-danger">Total Balance: NGN{{number_format($total_balance + $get_adjusted_interest,2)}}</h4>
