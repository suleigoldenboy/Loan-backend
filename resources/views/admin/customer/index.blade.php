            ...
            <div id="general-info" class="section general-info">
                <div class="info">
                    ...
                    <form action="" method="GET">
                     {{csrf_field()}}
                     @if(can('Admin Customer Search'))
                      @include('admin.customer.admin-search')
                    @endif
                    @if(can('Advance Customer Search'))
                      @include('admin.customer.advance-search')
                    @endif
                    @if(can('Branch Customer Search'))
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                    @foreach (getCustomerLoans($customer->id) as $loan) 
                                                                     <tr>
